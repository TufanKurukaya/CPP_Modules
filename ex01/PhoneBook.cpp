...
void PhoneBook::search_contact()
{
	...
	for (int i = 0; i < 8; i++)
	{
		...
		cout << std::setw(10) << contacts[i].resize_string(contacts[i].get_first_name()) << "|";
		cout << std::setw(10) << contacts[i].resize_string(contacts[i].get_last_name()) << "|";
	...
	cout << "First name:     " << contacts[index - 1].get_first_name() << endl;
	cout << "Last name:      " << contacts[index - 1].get_last_name() << endl;
